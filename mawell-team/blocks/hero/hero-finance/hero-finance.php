          ...
          ><i data-lucide="play" class="size-5"></i
            ...
            <div>
                <div class="relative z-20 opacity-100">
                    <img
                        src="<?php echo get_template_directory_uri() .'/examples/static/images/landing/finance/img-1.png' ?>"
                        class="mx-auto h-[700px] rounded-b-full"
                        alt=""
                    />
                    <div class="absolute end-0 top-40 -z-10">
                        <img
                            src="<?php echo get_template_directory_uri() .'/examples/static/images/landing/finance/bg-1.png' ?>"
                    ...
                    <div class="absolute inset-x-0 bottom-5 top-auto -z-10">
                        <img
                            src="<?php echo get_template_directory_uri() .'/examples/static/images/landing/finance/bg-2.png' ?>"
