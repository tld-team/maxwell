                ...
                <div class="lg:pb-20">
                    <div class="hs-accordion-group space-y-4">
						<?php foreach ( $questions as $index => $question ) : ?>
							<?php if ( $index == 0 ): ?>
                                <div class="hs-accordion active overflow-hidden rounded-lg border border-default-200"
							...
							<?php else: ?>
                                <div class="hs-accordion overflow-hidden rounded-lg border border-default-200"
                                     id="faq-<?php echo $index ?>">
                                    <button class="hs-accordion-toggle inline-flex w-full items-center justify-between gap-x-3 px-6 py-4 text-left capitalize text-default-950 transition-all"
